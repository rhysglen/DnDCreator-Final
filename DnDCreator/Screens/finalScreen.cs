    ...
    public partial class finalScreen : UserControl
    {
        public finalScreen()
        {
            ...
            if (Form1.newCharacter.skills.Contains("Athletics"))
            {
                ...
                skillModBox.Text += Form1.newCharacter.strMod;
                Form1.newCharacter.strMod = Form1.newCharacter.strMod - Form1.newCharacter.proficiency;
            }
            else
            {
        ...
        private void finishButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (Character c in Form1.charList)
            {
                ...
                writer.WriteElementString("hitdie", Convert.ToString(Form1.newCharacter.hitDie));
                writer.WriteElementString("hitpoints", Convert.ToString(Form1.newCharacter.hitPoints));
                writer.WriteElementString("strmod", Convert.ToString(Form1.newCharacter.strMod));
                writer.WriteElementString("dexmod", Convert.ToString(Form1.newCharacter.dexMod));
                writer.WriteElementString("constmod", Convert.ToString(Form1.newCharacter.constMod));
                writer.WriteElementString("wismod", Convert.ToString(Form1.newCharacter.wisMod));
                writer.WriteElementString("intmod", Convert.ToString(Form1.newCharacter.intMod));
                writer.WriteElementString("chamod", Convert.ToString(Form1.newCharacter.chaMod));
                writer.WriteElementString("proficiency", Convert.ToString(Form1.newCharacter.proficiency));
                writer.WriteElementString("strst", Convert.ToString(Form1.newCharacter.strST));
                writer.WriteElementString("dexST", Convert.ToString(Form1.newCharacter.dexST));
                writer.WriteElementString("constST", Convert.ToString(Form1.newCharacter.constST));
                writer.WriteElementString("wisST", Convert.ToString(Form1.newCharacter.wisST));
                writer.WriteElementString("intST", Convert.ToString(Form1.newCharacter.intST));
                writer.WriteElementString("chaST", Convert.ToString(Form1.newCharacter.chaST));
